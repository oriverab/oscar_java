...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light navbar-float">
      <div class="container">
        <a href="index.html" class="navbar-brand">ADOP<span class="text-primary">me.</span></a>
        ...
        <div class="navbar-collapse collapse" id="navbarContent">
          <ul class="navbar-nav ml-lg-4 pt-3 pt-lg-0">
            <li class="nav-item active">
              <a href="index.htm" class="nav-link">Inicio</a>
            </li>
            <li class="nav-item">
              <a href="listarMascotas.htm" class="nav-link">Mascotas</a>
            </li>
            <li class="nav-item">
              <a href="listar_Adopciones.htm" class="nav-link">Adopciones</a>
            </li>
            <li class="nav-item">
              <a href="listarClientes.htm" class="nav-link">Personas</a>
            </li>
      ...
      <div class="container h-100">
        <div class="row align-items-center h-100">
          ...
          <div class="col-lg-6 py-3 wow zoomIn">
            <div class="img-place">
                <img src="https://www.micachorro.net/wp-content/uploads/2019/01/los-perros-mas-hermosos-del-mundo-1.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-6 col-lg-4 py-3 wow fadeInUp">
            <div class="d-flex flex-row">
              <div class="img-fluid mr-3">
                <img src="public/img/icon_pattern.svg" alt="">
              </div>
              <div>
  ...
  <script src="publicpublic/vendor/wow/wow.min.js"></script>
  ...
  <script src="public/vendor/animateNumber/jquery.animateNumber.min.js"></script>
